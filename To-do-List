<h1>Razor Pages com ASP.NET CORE e SQLite</h1>
<h2>Podera criar Tarefa, pesquisar e na tarefa pode criar subtarefas coloca como concluído ou volta de volta para finalizar, Podera colocar os nome das tarefa e alterar a descrição das substarefas e salvando. (To-Do-List)</h2>
